    ...
    <div class="">
        <div class="panel-group" id="accordion">
            ...
            if (count($lisMenReport) > 0) {
                ...
                ?>
                <center><div style="padding: 20px 30px;  font-size: 16px; font-weight: 600;" class="alert alert-danger"><a  style="color: rgba(255, 255, 255, 0.9); display: inline-block; margin-right: 10px; text-decoration: none;">Lo sentimos, su perfil no cuenta con los privilegios suficientes para la visualización del Dashboard. Por favor consulte con el administrador del sistema. </a></div></center> 
                    <?php
                }
                ?>    
        </div>
